...
public class Locations_old2 extends DataObservable_old2<List<Location>> {
	
	public Locations_old2(Context context) {
		super(context);
	}

	private static List<Location> locationList;
	private static List<DataObserver_old2<List<Location>>> observers = 
			new ArrayList<DataObserver_old2<List<Location>>>();
	...
	@Override List<DataObserver_old2<List<Location>>> getObservers() {
		return observers;
	}
