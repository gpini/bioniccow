...
public class TaskLists_old2 extends DataObservable_old2<List<TaskList>> {
	
	public TaskLists_old2(Context context) {
		super(context);
	}

	private static List<TaskList> listList;
	private static List<DataObserver_old2<List<TaskList>>> observers = 
			new ArrayList<DataObserver_old2<List<TaskList>>>();
	...
	@Override List<DataObserver_old2<List<TaskList>>> getObservers() {
		return observers;
	}
