...
public class AccountSettings_old extends DataObservable_old2<Settings> {
	
	public AccountSettings_old(Context context) {
		super(context);
	}

	private static Settings settings;
	private static List<DataObserver_old2<Settings>> observers = 
			new ArrayList<DataObserver_old2<Settings>>();
	...
	@Override List<DataObserver_old2<Settings>> getObservers() {
		return observers;
	}
